...
namespace Cosmos
{
		...
		: Entity("Plane"), mRenderer(renderer), mCamera(camera)
	{
		...
		mVertices[0].tint = { offsetGlobal * 0.1f, 1.0f, 0.0f };
		mVertices[1].tint = { offsetGlobal * 1.0f, 1.0f, 0.0f };
		mVertices[2].tint = { offsetGlobal * 0.5f, 0.35f, 0.4f };
		mVertices[3].tint = { offsetGlobal * 0.1f, 1.0f, 1.0f };
